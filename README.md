...
<table>
   <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li>Inline diagnostics — no extra setup</li>
        <li>Sidebar panel with jump-to-usage</li>
        <li>Supports Laravel, Symfony, Node.js, Spring Boot</li>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        ...
        <img src="https://img.shields.io/badge/Spring_Boot_3.5-6DB33F?style=flat&logo=springboot&logoColor=white" />
        <img src="https://img.shields.io/badge/Kafka-231F20?style=flat&logo=apachekafka&logoColor=white" />
        <img src="https://img.shields.io/badge/Docker-2496ED?style=flat&logo=docker&logoColor=white" />
      </p>
      <ul>
        <li>JWT auth, OpenAPI/Swagger docs</li>
